...
SkillManager 在 [skill_manager.py#L493-648](file:///c:/Users/z/DockerApp/MyAgentBot/AstrBot/data/plugins/astrbot_plugin_my_demo/.venv/Lib/site-packages/astrbot/core/skills/skill_manager.py#L493-L648) 中按以下顺序发现 Skill：
...
通过 `skills.json` 配置文件管理（[skill_manager.py#L418-430](file:///c:/Users/z/DockerApp/MyAgentBot/AstrBot/data/plugins/astrbot_plugin_my_demo/.venv/Lib/site-packages/astrbot/core/skills/skill_manager.py#L418-L430)）：
...
Skill 在每次 LLM 请求的 system prompt 构建阶段注入（[astr_main_agent.py#L529-561](file:///c:/Users/z/DockerApp/MyAgentBot/AstrBot/data/plugins/astrbot_plugin_my_demo/.venv/Lib/site-packages/astrbot/core/astr_main_agent.py#L529-L561)）：
...
[build_skills_prompt()](file:///c:/Users/z/DockerApp/MyAgentBot/AstrBot/data/plugins/astrbot_plugin_my_demo/.venv/Lib/site-packages/astrbot/core/skills/skill_manager.py#L208-L283) 会生成以下格式的 prompt：
...
`SkillManager`（[skill_manager.py#L287](file:///c:/Users/z/DockerApp/MyAgentBot/AstrBot/data/plugins/astrbot_plugin_my_demo/.venv/Lib/site-packages/astrbot/core/skills/skill_manager.py#L287)）是 Skill 的管理中心。
...
AstrBot 提供了一组操作 Skill 的内置工具（Neo Skill 工具），定义在 [neo_skills.py](file:///c:/Users/z/DockerApp/MyAgentBot/AstrBot/data/plugins/astrbot_plugin_my_demo/.venv/Lib/site-packages/astrbot/core/tools/computer_tools/shipyard_neo/neo_skills.py) 中，它们都是 `NeoSkillToolBase` 的子类。
...
在 [astr_main_agent.py#L543-553](file:///c:/Users/z/DockerApp/MyAgentBot/AstrBot/data/plugins/astrbot_plugin_my_demo/.venv/Lib/site-packages/astrbot/core/astr_main_agent.py#L543-L553) 中，如果 Persona 配置了 `skills` 字段，会按列表过滤 Skill：
...
| 文件 | 说明 |
|------|------|
| [skill_manager.py](file:///c:/Users/z/DockerApp/MyAgentBot/AstrBot/data/plugins/astrbot_plugin_my_demo/.venv/Lib/site-packages/astrbot/core/skills/skill_manager.py) | Skill 管理核心类 |
| [neo_skill_sync.py](file:///c:/Users/z/DockerApp/MyAgentBot/AstrBot/data/plugins/astrbot_plugin_my_demo/.venv/Lib/site-packages/astrbot/core/skills/neo_skill_sync.py) | Neo Skill 同步管理器 |
| [neo_skills.py](file:///c:/Users/z/DockerApp/MyAgentBot/AstrBot/data/plugins/astrbot_plugin_my_demo/.venv/Lib/site-packages/astrbot/core/tools/computer_tools/shipyard_neo/neo_skills.py) | Skill 操作工具（Neo） |
| [astr_main_agent.py#L529-561](file:///c:/Users/z/DockerApp/MyAgentBot/AstrBot/data/plugins/astrbot_plugin_my_demo/.venv/Lib/site-packages/astrbot/core/astr_main_agent.py#L529-L561) | Skill 注入主 Agent 的逻辑 |
| [computer_client.py#L108-114](file:///c:/Users/z/DockerApp/MyAgentBot/AstrBot/data/plugins/astrbot_plugin_my_demo/.venv/Lib/site-packages/astrbot/core/computer/computer_client.py#L108-L114) | Sandbox Skill 扫描与缓存 |
...
根据 [skill_manager.py#L493-640](file:///c:/Users/z/DockerApp/MyAgentBot/AstrBot/data/plugins/astrbot_plugin_my_demo/.venv/Lib/site-packages/astrbot/core/skills/skill_manager.py#L493-L640)，Skill 有三种来源：
...
这些工具都是 `NeoSkillToolBase` 的子类，定义在 [neo_skills.py#L53](file:///c:/Users/z/DockerApp/MyAgentBot/AstrBot/data/plugins/astrbot_plugin_my_demo/.venv/Lib/site-packages/astrbot/core/tools/computer_tools/shipyard_neo/neo_skills.py#L53)。
...
- [astr_main_agent.py#L529-561](file:///c:/Users/z/DockerApp/MyAgentBot/AstrBot/data/plugins/astrbot_plugin_my_demo/.venv/Lib/site-packages/astrbot/core/astr_main_agent.py#L529-L561) — 唯一调用 `skill_manager.list_skills()` 和 `build_skills_prompt()` 的地方

而 SubAgent 的执行路径中**没有任何 Skill 相关代码**：

- [astr_agent_tool_exec.py](file:///c:/Users/z/DockerApp/MyAgentBot/AstrBot/data/plugins/astrbot_plugin_my_demo/.venv/Lib/site-packages/astrbot/core/astr_agent_tool_exec.py) — 0 处 Skill 引用
- [context.py](file:///c:/Users/z/DockerApp/MyAgentBot/AstrBot/data/plugins/astrbot_plugin_my_demo/.venv/Lib/site-packages/astrbot/core/star/context.py) — `tool_loop_agent` 只透传 `system_prompt` 参数，不处理 Skill
