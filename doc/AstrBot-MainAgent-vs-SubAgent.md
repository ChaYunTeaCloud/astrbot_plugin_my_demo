...
| 6 | **SubAgent 无文件提取能力** | SubAgent 无法从 URL 提取文件内容 | [astr_agent_tool_exec.py#L359-L370](../.venv/Lib/site-packages/astrbot/core/astr_agent_tool_exec.py#L359-L370) | 执行路径未经过 [astr_main_agent.py#L1543-L1547](../.venv/Lib/site-packages/astrbot/core/astrbot_plugin_my_demo#L1543-L1547) 的 `_apply_file_extract()` | 暂无，需自行实现文件提取逻辑 |
| 7 | **SubAgent 无插件工具过滤** | SubAgent 可能使用到当前会话未启用的插件工具 | [astr_agent_tool_exec.py#L244-L298](../.venv/Lib/site-packages/astrbot/core/astrbot_plugin_my_demo#L244-L298) | 未调用 [astr_main_agent.py#L1027-L1053](../.venv/Lib/site-packages/astrbot/core/astrbot_plugin_my_demo#L1027-L1053) 的 `_plugin_tool_fix()` | 自定义工具时自行实现插件级过滤 |
...
| 9 | **SubAgent 无主动消息能力** | SubAgent 无法主动向用户发送消息 | [astr_agent_tool_exec.py#L359-L370](../.venv/Lib/site-packages/astrbot/core/astr_agent_tool_exec.py#L359-L370) | 未经过 [astr_main_agent.py#L1584-L1591](../.venv/Lib/site-packages/astrbot/core/astrbot_plugin_my_demo#L1584-L1591) 的主动消息工具注入 | 暂无，需通过 MainAgent 间接发送 |
...
astrbot/core/subagent_orchestrator.py#L29-L104 `reload_from_config`
...
astrbot/core/astr_main_agent.py#L620-L625
...
astrbot/core/astr_agent_tool_exec.py#L300-L370 `_execute_handoff`

```
_build_handoff_toolset() 构建工具集 → 准备 begin_dialogs → 调用 tool_loop_agent()
```

其中 `_build_handoff_toolset` 在 [astr_agent_tool_exec.py#L244-L298](../.venv/Lib/site-packages/astrbot/core/astrbot_plugin_my_demo#L244-L298)，是构建 SubAgent 工具集的核心方法。
...
[astr_main_agent.py](file:///c:/Users/z/DockerApp/MyAgentBot/AstrBot/data/plugins/astrbot_plugin_my_demo/.venv/Lib/site-packages/astrbot/core/astr_main_agent.py) `build_main_agent` 函数
