...
> 源码路径：
> - Star 基类: `../.venv/Lib/site-packages/astrbot/core/star/base.py`
> - StarMetadata: `../.venv/Lib/site-packages/astrbot/core/star/star.py`
> - StarTools: `../.venv/Lib/site-packages/astrbot/core/star/star_tools.py`
> - register_star: `../.venv/Lib/site-packages/astrbot/core/star/register/star.py`
> - config: `../.venv/Lib/site-packages/astrbot/core/star/config.py`
...
它的位置在 `../.venv/Lib/site-packages/astrbot/core/star/star_handler.py`，所以名字叫 "Star Handler 注册表"。它存储了**所有插件注册的 Handler**——不管是命令、事件钩子、还是 LLM 工具，全在这一个注册表里。
...
说明位置：../.venv/Lib/site-packages/astrbot/core/star/config.py
