...
> 源码路径：
> - API 导出: `astrbot/api/provider/__init__.py`
> - Provider 基类: `astrbot/core/provider/provider.py`
> - 实体类: `astrbot/core/provider/entities.py`
> - 注册机制: `astrbot/core/provider/register.py`
> - 管理器: `astrbot/core/provider/manager.py`
...
**文件**：astrbot/api/provider/__init__.py
...
**文件**：astrbot/core/provider/entities.py#L27
...
**文件**：astrbot/core/provider/entities.py#L88
...
**文件**：astrbot/core/provider/entities.py#L294
...
**文件**：astrbot/core/provider/entities.py#L35
...
**文件**：astrbot/core/provider/entities.py#L50
...
**文件**：astrbot/core/provider/entities.py#L262
...
**文件**：astrbot/core/provider/entities.py#L63
...
**文件**：astrbot/core/provider/entities.py#L442
...
**文件**：astrbot/core/provider/provider.py#L27
...
**文件**：astrbot/core/provider/provider.py#L66
...
**文件**：astrbot/core/provider/provider.py#L214
...
**文件**：astrbot/core/provider/provider.py#L234
...
**文件**：astrbot/core/provider/provider.py#L320
...
**文件**：astrbot/core/provider/provider.py#L412
...
**文件**：astrbot/core/provider/register.py
