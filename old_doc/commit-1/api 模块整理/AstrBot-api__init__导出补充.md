...
> 源码路径：`astrbot/api/__init__.py`

---

## 一、概述

`astrbot/api/__init__.py` 是 AstrBot 插件开发的**主要入口**，从这里导出的对象可以直接通过 `from astrbot.api import xxx` 使用。此文档补充那些在其他专题文档中未详细覆盖的导出项。
...
**源码**：`astrbot/core/config/astrbot_config.py`
...
**源码**：`astrbot/core/agent/tool_executor.py`
...
**源码**：`astrbot/core/star/register/star_handler.py#L697`
...
**源码**：`astrbot/core/utils/t2i/renderer.py`
...
**源码**：`astrbot/core/__init__.py`（第 36 行）
...
**源码**：`astrbot/core/utils/shared_preferences.py`
