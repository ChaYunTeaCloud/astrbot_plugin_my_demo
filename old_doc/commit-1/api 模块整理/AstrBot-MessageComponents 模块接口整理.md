...
> 源码路径：
> - API 导出: `astrbot/api/message_components.py`
> - 实现: `astrbot/core/message/components.py`
...
**文件**：astrbot/api/message_components.py
...
**文件**：astrbot/core/message/components.py#L44
...
**文件**：astrbot/core/message/components.py#L71
...
**文件**：astrbot/core/message/components.py#L111
...
**文件**：astrbot/core/message/components.py#L499
...
**文件**：astrbot/core/message/components.py#L133
...
**文件**：astrbot/core/message/components.py#L286
...
**文件**：astrbot/core/message/components.py#L761
...
**文件**：astrbot/core/message/components.py#L408
...
**文件**：astrbot/core/message/components.py#L423
...
**文件**：astrbot/core/message/components.py#L582
...
**文件**：astrbot/core/message/components.py#L125
...
**文件**：astrbot/core/message/components.py#L612
...
**文件**：astrbot/core/message/components.py#L653
...
**文件**：astrbot/core/message/components.py#L707
...
**文件**：astrbot/core/message/components.py#L451
